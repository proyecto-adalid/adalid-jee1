...
/**
 * TipoDocumento Persistent Entity.
 *
 * @author Jorge Campins
 */
@EntityClass(resourceType = ResourceType.CONFIGURATION)
public class TipoDocumento extends PersistentEnumerationEntityBase {
...
/**/
    ...
    public TipoDocumento(Artifact declaringArtifact, Field declaringField) {
        super(declaringArtifact, declaringField);
    }
    // </editor-fold>

    public Instance CLIENTE;

    public Instance PRODUCTO;
