...
public class Producto extends AbstractPersistentEntity {
...
/**/
     ...
     */
    @BigDecimalField(precision = 9, scale = 2)
    ...
    public BigDecimalProperty precio;
    ...
    protected void settleProperties() {
        ...
        precio.setMinValue(1);
        precio.setMaxValue(1000);
    }
    ...
    public class ActualizarPrecio extends ProcessOperation {

        @InstanceReference
        protected Producto producto;

        @NumericField(divisorRule = DivisorRule.ROUND)
        @ParameterField(linkedField = "precio", required = Kleenean.TRUE)
        protected BigDecimalParameter precio;
