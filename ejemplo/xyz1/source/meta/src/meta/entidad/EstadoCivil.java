...
/**
 * EstadoCivil Persistent Entity.
 *
 * @author Jorge Campins
 */
public class EstadoCivil extends AbstractPersistentEnumerationEntity {
...
/**/
    ...
    public EstadoCivil(Artifact declaringArtifact, Field declaringField) {
    ...
    public Instance SOLTERO;

    public Instance CASADO;

    public Instance VIUDO;

    public Instance DIVORCIADO;
