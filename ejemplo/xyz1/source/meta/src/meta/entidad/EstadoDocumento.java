...
import meta.entidad.base.*;

/**
 * EstadoDocumento Persistent Entity.
 *
 * @author Jorge Campins
 */
@EntityClass(resourceType = ResourceType.CONFIGURATION)
public class EstadoDocumento extends PersistentEnumerationEntityBase {
...
/**/
    ...
    public EstadoDocumento(Artifact declaringArtifact, Field declaringField) {
    ...
    public Instance MODIFICABLE;

    public Instance VERIFICABLE;

    public Instance VERIFICADO;

    public Instance RECHAZADO;
