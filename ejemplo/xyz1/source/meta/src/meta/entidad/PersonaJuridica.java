...
/**
 * PersonaJuridica Persistent Entity.
 *
...
/**/
     ...
     */
    @PropertyField(create = Kleenean.TRUE)
    @NumericDataGen(min = "10000", max = "1000000")
    ...
    @PropertyField(create = Kleenean.TRUE)
    public PersonaNatural contacto;
    ...
    protected Tab tab201;

    @Override
    protected void settleTabs() {
        super.settleTabs();
        setDefaultTab(tab201);
        tab201.setDefaultLabel("persona jurídica");
        tab201.newTabField(fechaRegistro, capitalPagado, capitalSuscrito, contacto, matriz);
    }
