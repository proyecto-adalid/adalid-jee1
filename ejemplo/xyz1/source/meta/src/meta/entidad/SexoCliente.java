...
/**
 * SexoCliente Persistent Entity.
 *
 * @author Jorge Campins
 */
public class SexoCliente extends AbstractPersistentEnumerationEntity {
...
/**/
    ...
    public SexoCliente(Artifact declaringArtifact, Field declaringField) {
    ...
    protected void settleAttributes() {
        ...
        setDefaultCollectionLabel("sexos de cliente");
        setDefaultCollectionShortLabel("sexos");
        setDefaultLabel("sexo de cliente");
        setDefaultShortLabel("sexo");
    }
