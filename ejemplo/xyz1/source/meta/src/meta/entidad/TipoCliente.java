...
/**
 * TipoCliente Persistent Entity.
 *
 * @author Jorge Campins
 */
public class TipoCliente extends AbstractPersistentEnumerationEntity {
...
/**/
    ...
    public TipoCliente(Artifact declaringArtifact, Field declaringField) {
    ...
    protected void settleAttributes() {
        ...
        setDefaultCollectionLabel("tipos de cliente");
        setDefaultCollectionShortLabel("tipos");
        setDefaultLabel("tipo de cliente");
    ...
    public Instance PERSONA_JURIDICA;

    public Instance PERSONA_NATURAL;
